  ...
  return (
    <div ref={containerRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        {/* Left Phone Mockup - Marketplace/Home */}
        <motion.div 
            style={{ y: yLeft, opacity }}
            className="relative mx-auto lg:ml-auto lg:mr-0 group perspective-1000"
        >
           {/* Phone Container */}
           <div className="relative w-[300px] sm:w-[320px] h-[600px] sm:h-[640px] bg-black rounded-[3rem] border-8 border-gray-800 shadow-2xl overflow-hidden transform transition-transform duration-700 hover:rotate-y-3 hover:scale-[1.02] z-10 mx-auto">
           ...
           {/* Decorative Floating Label - Positioned carefully */}
           <motion.div 
              initial={{ x: 50, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="hidden xl:block absolute -right-20 top-24 bg-white border border-gray-100 p-5 rounded-2xl w-56 shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-20 transform transition-transform duration-500 hover:-translate-y-1"
           >
        ...
        {/* Right Phone Mockup - Community/Feed */}
        <motion.div 
            style={{ y: yRight, opacity }}
            className="relative mx-auto lg:mr-auto lg:ml-0 group perspective-1000 lg:mt-32"
        >
            {/* Phone Container */}
            <div className="relative w-[300px] sm:w-[320px] h-[600px] sm:h-[640px] bg-white rounded-[3rem] border-8 border-gray-800 shadow-2xl overflow-hidden transform transition-transform duration-700 hover:rotate-y-[-3deg] hover:scale-[1.02] z-10 mx-auto">
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-7 bg-black rounded-b-xl z-20"></div>
            ...
            <motion.div 
               ...
               className="hidden xl:block absolute -left-20 top-24 bg-white border border-gray-100 p-5 rounded-2xl w-56 shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-20 transform transition-transform duration-500 hover:-translate-y-1"
            >
              <div className="flex items-center gap-3 mb-2">
                  <div className="relative flex h-3 w-3">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-yellow opacity-75"></span>
