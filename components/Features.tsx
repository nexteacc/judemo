      ...
      >
        ...
        <div className="flex flex-col gap-8 h-full">
            ...
            <motion.div 
                ...
                className="glass-card rounded-3xl p-8 flex items-center justify-between group hover:shadow-lg transition-all duration-300 bg-white/80 h-full border border-black/5"
            >
                <div>
